...
let path = {
	build: {
		...
		iconsfont: project_folder + "/iconsfont/",
	...
	src: {
		...
		videos: source_folder + "/videos/**/*.{mp4,webm,ogg}",
		iconsfont: source_folder + "/iconsfont/*.{eot,svg,ttf,woff}",
...
let build = gulp.series(clean, gulp.parallel(js, css, html, json, images, fonts, videos, iconsfont), fontsStyle);
